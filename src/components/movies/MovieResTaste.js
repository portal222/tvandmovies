...
const MovieResTaste = () => {
   ...
   const params = useParams()
    ...
    const getDetails = async () => {
        ...
        const url = `https://www.omdbapi.com/?s=${name}&apikey=f91358c4&page=1&type=movie`;
        ...
        try {
            ...
            console.log("res taste detalji", data)
    ...
    return (
        <>
            {error ? (
                ...
                <>
                    <div className="gridTv" style={{ paddingTop: "60px", paddingLeft: "25px" }}>
                        <p className="time">{totalMovies} results in Movie base for: {name}</p>
                    </div>
